...
public class HttpUtil {
	...
	public HttpUtil setRequestUrl(String requestUrl) {
		this.requestUrl = requestUrl;
		return this;
	}
	...
	public HttpUtil setOutCharSet(String outCharSet) {
	...
	public HttpUtil setRequestParam(String param) {
	...
	public HttpUtil setRequestParam(String key, String val){
	...
	public HttpUtil setRequestParam(@SuppressWarnings("rawtypes") Map paramMap){
		String paramStr = "";
		if (paramMap != null) {
	...
	public HttpUtil setRequestMethod(String method) {
	...
	public HttpUtil setHeaders(String key, String val){
